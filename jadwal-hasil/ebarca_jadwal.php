...
$tag = $value['tag'];
$kode = $value['kode'];
$url = "http://www.goal.com/id-ID/fixtures/team/$tag/$kode";
$musim = 2016;
...
foreach ($html->find('table[class=match-table]') as $li) {
	...
	$waktu = $tgl." ".$jam;
        ...
        $sql = "INSERT INTO ebarca_jadwal (tag,is_kandang,waktu,musim,lawan,url_img_tim,url_img_lawan,time) VALUES ('$tag','$is_kandang','$waktu','$musim','$lawan','$url_img_tim','$url_img_lawan','$time')";
